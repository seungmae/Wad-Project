...
import kotlinx.android.synthetic.main.activity_popular_share.*
import kotlinx.android.synthetic.main.item_detail.view.*
import kotlinx.android.synthetic.main.snippet_top_popularsharetoolbar.*

import kotlin.collections.ArrayList

class PopularShareActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_popular_share)
    ...
    inner class ShareRecyclerviewAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(){
        ...
        override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
            ...
            //프로그레스
            val circularProgressDrawable = CircularProgressDrawable(this@PopularShareActivity)
